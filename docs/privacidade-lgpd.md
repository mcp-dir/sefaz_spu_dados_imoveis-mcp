...
SEFAZ SPU: Dados Cadastrais de Imóvel da União segue a LGPD (Lei nº 13.709/2018).
...
Acessar, corrigir, eliminar, portar, revogar consentimento. Contato: [sefaz_spu_dados_imoveis@mcp.ai](mailto:sefaz_spu_dados_imoveis@mcp.ai). Reclamações: [ANPD](https://www.gov.br/anpd/pt-br).
